...
import { referanceTypeSchema } from '../shared/primitives';
...
export const ctaButtonSchema = z.object({
  ...
  width: z.enum([WIDTHS.FULL, WIDTHS.WIDE, WIDTHS.RESPONSIVE]).default(WIDTHS.RESPONSIVE),
  links: referanceTypeSchema.array().default([]),
});
