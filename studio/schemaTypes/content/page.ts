    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: 'string',
          description:
            'Optional page-specific SEO title. Leave empty to use the global default or page title.',
        ...
        defineField({
          ...
          rows: 3,
          description:
            'Optional page-specific description for search engines and social previews. Leave empty to use the global default.',
          validation: (Rule) =>
        ...
        defineField({
          ...
          type: 'image',
          description:
            'Optional page-specific social sharing image. This is used in link previews on places like iMessage, Slack, Facebook, and Discord. Leave empty to use the global default image.',
          options: {
            hotspot: true,
          },
          fields: [
